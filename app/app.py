...
-  Comparar el comportamiento de una variable para varios países.
    ...
    pdf_url = "https://raw.githubusercontent.com/marcmenendezz/impacto-economico-poblacion-mundial/main/docs/Memoria%20Proyecto.pdf"
    ...
    if response.status_code == 200:
        st.download_button(
            ...
            file_name="Memoria%20Proyecto.pdf",
    ...
    for col in resumen_comp.columns[1:]:
        resumen_comp[col] = resumen_comp[col].apply(formatear_numero)
